    ...
    <div class="flex flex-col items-center justify-center h-screen">
      ...
      <p class="mb-6">Veuillez entrer l'adresse email associée à votre compte et choisir votre nouveau mot de passe.</p>
        ...
        <div class="relative mb-2 w-full">
          ...
          <input v-model="formData.confirm_password" :type="showConfirmPassword ? 'text' : 'password'" id="confirmPassword" class="bg-gray-50 border border-black text-sm rounded-lg  block w-full p-2.5 "               :class="{
