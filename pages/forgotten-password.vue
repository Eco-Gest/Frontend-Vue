<template>
  <div class="flex flex-col items-center justify-center h-screen">
    ...
    <div class="sm:w-80 w-72 flex flex-col" v-if="!emailSent">
      <h1 class="text-2xl font-bold mb-2 hidden sm:block">Mot de passe oublié</h1>
    ...
    <div class="sm:w-80 w-72 flex flex-col" v-else>
      ...
      <p>Un email de réinitialisation de mot de passe a été envoyé à l'adresse que vous avez fournie. Veuillez vérifier
        votre boîte de réception et suivre les instructions fournies dans l'email pour réinitialiser votre mot de passe.
      </p>
      <!-- Sign Up Link -->
